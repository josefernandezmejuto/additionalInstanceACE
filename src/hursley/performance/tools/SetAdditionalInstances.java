...
public class SetAdditionalInstances {
  public static void main(String[] args) {
    ...
    if (parameterCount < 3 && parameterCount > 6) {
      System.out.println("");
      System.out.println(help);
      throw new IllegalArgumentException("Invalid number of parameters - You supplied " + parameterCount + ", must be between 3 and 6");
    } 
        ...
        try {
          ...
          while (EGs.hasMoreElements()) {
            ...
            if (server != null && !server.equals(EG.getName())) {
              System.out.println("-Skipping ServerName=" + EG.getName() + ", is running=" + EG.isRunning());
              continue;
            } 
            ...
            if ((APPs == null || !APPs.hasMoreElements()) && (MFs == null || !MFs.hasMoreElements()) && (RestAPIs == null || !RestAPIs.hasMoreElements())) {
            ...
            while (MFs.hasMoreElements()) {
              ...
              if (messageflow != null && !messageflow.equals(MF.getName())) {
                System.out.println("--Skipping MessageFlowName=" + MF.getName() + " , AdditionalInstances=" + ai + " , is running=" + EG.isRunning());
                continue;
              } 
              System.out.println("--MessageFlowName=" + MF.getName() + " , AdditionalInstances=" + ai + " , is running=" + EG.isRunning());
              if (MF.isRunning() && numberOfAdditionalInstances != ai) {
                System.out.println("---Setting AdditionalInstances=" + numberOfAdditionalInstances);
                MF.setAdditionalInstances(numberOfAdditionalInstances);
                System.out.println("---New AdditionalInstances=" + MF.getAdditionalInstances());
                messageFlowsChanges++;
                continue;
              } 
            ...
            while (APPs.hasMoreElements()) {
              ...
              while (AppMFs.hasMoreElements()) {
                ...
                if (restapi != null || (application != null && (!application.equals(APP.getName()) || (messageflow != null && !messageflow.equals(AppMF.getName()))))) {
                  System.out.println("--Skipping Application=" + APP.getName() + "--MessageFlowName=" + AppMF.getName() + " , AdditionalInstances=" + ai + " , is running=" + EG.isRunning());
                  continue;
                } 
                System.out.println("--Application=" + APP.getName() + "--MessageFlowName=" + AppMF.getName() + " , AdditionalInstances=" + ai + " , is running=" + EG.isRunning());
                if (AppMF.isRunning() && numberOfAdditionalInstances != ai) {
                  System.out.println("---Setting AdditionalInstances=" + numberOfAdditionalInstances);
                  AppMF.setAdditionalInstances(numberOfAdditionalInstances);
                  System.out.println("---New AdditionalInstances=" + AppMF.getAdditionalInstances());
                  messageFlowsChanges++;
                  continue;
                } 
                messageFlowsNotChanged++;
            ...
            while (RestAPIs.hasMoreElements()) {
              ...
              while (RestMFs.hasMoreElements()) {
                ...
                if (application != null || (restapi != null && !restapi.equals(RestAPI.getName()))) {
                  System.out.println("--Skipping RestAPI=" + RestAPI.getName() + "--MessageFlowName=" + RestMF.getName() + " , AdditionalInstances=" + ai + " , is running=" + EG.isRunning());
                  continue;
                } 
                System.out.println("--RestAPI=" + RestAPI.getName() + "--MessageFlowName=" + RestMF.getName() + " , AdditionalInstances=" + ai + " , is running=" + EG.isRunning());
                if (RestMF.isRunning() && numberOfAdditionalInstances != ai) {
                  System.out.println("---Setting AdditionalInstances=" + numberOfAdditionalInstances);
                  RestMF.setAdditionalInstances(numberOfAdditionalInstances);
                  System.out.println("---New AdditionalInstances=" + RestMF.getAdditionalInstances());
                  messageFlowsChanges++;
                  continue;
                } 
                messageFlowsNotChanged++;
